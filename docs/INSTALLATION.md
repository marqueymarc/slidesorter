...
```sh
pipx install "https://github.com/marqueymarc/slidesorter/releases/latest/download/slidesorter-3.9.2-py3-none-any.whl"
```
...
docker run --rm \
  ...
  ghcr.io/marqueymarc/slidesorter:3.9.2
```
